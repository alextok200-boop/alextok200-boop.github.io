...
(function () {
  var DICT = {
    ...
    "brands.auth.cta": { zh: "申请品牌授权", en: "Apply for Licensing" },
    "brands.auth.title": { zh: "品牌授权申请", en: "Brand Licensing Application" },
    "brands.auth.intro": { zh: "适用于经销商 / 代理商 / 达人 / 线下门店等需要正式品牌授权的合作方。提交后由集团审批，正式条款以授权函与 OA 审批为准。", en: "For distributors, agents, creators and offline stores that need formal brand licensing. Applications go through group approval; official terms follow the license letter and OA approval." },
    "brands.auth.coop": { zh: "申请类型", en: "Application Type" },
    "brands.auth.channel": { zh: "销售渠道", en: "Sales Channel" },
    "brands.auth.market": { zh: "目标市场", en: "Target Market" },
    "brands.auth.market.ph": { zh: "如：北美 / 东南亚 / 国内华东（选填）", en: "e.g. North America / SEA / East China (optional)" },
    "brands.auth.store": { zh: "现有店铺 / 主页链接", en: "Existing Store / Page URL" },
    "brands.auth.store.ph": { zh: "https://…（选填）", en: "https://… (optional)" },
    "brands.auth.scale": { zh: "预计规模", en: "Expected Scale" },
    "brands.auth.msg.ph": { zh: "简要说明合作规划：渠道资源、目标市场、预计采购量等", en: "Briefly describe your plan: channel resources, target market, expected order volume" },
    "brands.auth.send": { zh: "提交授权申请", en: "Submit Application" },
