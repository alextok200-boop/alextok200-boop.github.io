...
(function () {
  var DICT = {
    ...
    "job3.title": { zh: "跨境电商运营（Amazon / Temu）", en: "Cross-border E-commerce Operator (Amazon / Temu)" },
    "job3.loc": { zh: "南通（跨境主阵地）· 南京", en: "Nantong (cross-border hub) · Nanjing" },
    "job3.type": { zh: "全职", en: "Full-time" },
    "job3.dept": { zh: "跨境电商", en: "Cross-border E-commerce" },
    "job3.report.val": { zh: "跨境负责人 / 平台负责人", en: "Cross-border Lead / Platform Lead" },
    "job3.desc": { zh: "负责 Amazon 多站点与 Temu 半 / 全托管运营：以 Listing + 广告 + FBA 驱动 GMV 与排名，以备货履约与核价驱动走量与毛利。该岗位为储备状态，业务放量时开放，可先投简历进入人才池。", en: "Own Amazon multi-marketplace and Temu semi / fully-managed operations — Listing, ads and FBA drive GMV and rank; stock fulfilment and price negotiation drive volume and margin. Currently a talent-pool role: send your CV and we'll reach out when the business scales." },
    "job3.d1": { zh: "Listing：标题 / 图文 / A+ 优化与关键词，维护 Listing 表", en: "Listing: titles, images, A+ content and keywords; maintain the listing sheet" },
    "job3.d2": { zh: "广告：SP / SB / SD 结构与 ACOS 优化，做否定词与预算再分配", en: "Ads: SP / SB / SD structure and ACOS control; negative keywords and budget reallocation" },
    "job3.d3": { zh: "FBA 库存：补货计划与库存周转，控 IPI，不断货不积压", en: "FBA inventory: replenishment planning and turnover; keep IPI healthy, no stockouts or overhang" },
    "job3.d4": { zh: "合规与评分：合规索评、类目审核与账户健康维护", en: "Compliance and ratings: compliant review requests, category approvals and account health" },
    "job3.d5": { zh: "Temu 履约：国内仓备货、核价跟进与爆款选品，控退货率", en: "Temu fulfilment: domestic warehouse stocking, price negotiation and hit product selection; control return rate" },
    "job3.d6": { zh: "数据复盘：销量与毛利复盘，输出周报与迭代动作", en: "Review: sales and margin analysis, ship weekly reports with next actions" },
    "job3.r1": { zh: "大专及以上，电子商务 / 市场营销优先", en: "College degree or above; e-commerce / marketing preferred" },
    "job3.r2": { zh: "2 年以上 Amazon 或 Temu 运营经验，有台球 / 运动器材类目优先", en: "2+ years on Amazon or Temu; billiards / sports equipment category a plus" },
    "job3.r3": { zh: "Amazon：懂 A9 算法、关键词与转化逻辑、FBA 与自发货差异、Coupon / BD / LD 节奏", en: "Amazon: understands A9 ranking, keyword and conversion logic, FBA vs. FBM, and Coupon / BD / LD cadence" },
    "job3.r4": { zh: "Temu：懂核价逻辑与毛利空间，能推动备货节奏避免断货 / 积压", en: "Temu: understands price-negotiation logic and margin headroom; drives stocking cadence to avoid stockouts and overhang" },
    "job3.r5": { zh: "数据敏感、执行强、抗压，能用数据定位断点并迭代", en: "Data-sensitive, strong execution, resilient; locates funnel breakpoints with data and iterates" },
    "job3.k1": { zh: "GMV 达成率", en: "GMV attainment" },
    "job3.k2": { zh: "ACOS ≤ 红线（Amazon）/ 履约时效 ≤ SLA（Temu）", en: "ACOS ≤ threshold (Amazon) / fulfilment ≤ SLA (Temu)" },
    "job3.k3": { zh: "BSR 排名（Amazon）/ 毛利率 ≥ 红线（Temu）", en: "BSR ranking (Amazon) / gross margin ≥ threshold (Temu)" },
    "job3.k4": { zh: "库存周转（Amazon）/ 缺货率 ≤ 红线（Temu）", en: "Inventory turnover (Amazon) / stockout rate ≤ threshold (Temu)" },
    "job3.k5": { zh: "评分 ≥ 红线（Amazon）/ 退货率 ≤ 红线（Temu）", en: "Rating ≥ threshold (Amazon) / return rate ≤ threshold (Temu)" },
    "job3.sys.val": { zh: "Amazon Seller Central（美 / 加 / 英 / 德 / 日 5 站）、广告与品牌分析、Temu 半托管·全托管后台", en: "Amazon Seller Central (US / CA / UK / DE / JP), Ads and Brand Analytics, Temu semi- and fully-managed console" },
    "job3.plus": { zh: "加分项：Amazon 多站点（美 / 加 / 英 / 德 / 日）实操、海外仓资源、小语种。", en: "Bonus: hands-on Amazon multi-marketplace (US / CA / UK / DE / JP), overseas warehouse resources, extra languages." },
    "job3.red.val": { zh: "刷评 / 刷单 / 跟卖侵权 / 规避二审 / 虚假发货 / 货不对板 / 恶意低价扰乱", en: "Fake reviews, fake orders, hijacking or IP infringement, evading secondary verification, fake shipping, product mismatch, malicious underpricing" },
    "job4.title": { zh: "运营自动化 / AI 技能包工程", en: "Ops Automation / AI Skill Pack Engineering" },
    "job4.loc": { zh: "远程协作 · 南京", en: "Remote · Nanjing" },
    "job4.type": { zh: "全职 / 兼职", en: "Full-time / Part-time" },
    "job4.dept": { zh: "数据与增长（技术中台）", en: "Data & Growth (Tech Platform)" },
    "job4.report.val": { zh: "技术负责人 / 副总", en: "Tech Lead / VP" },
    "job4.desc": { zh: "技术 / 数据中台支撑岗。打通各平台 API → 沉淀数据底座 → 运维服务器 → 迭代 AI 需求，把投流审核、视觉生产、数据看板、OA 审批这类重复工作封装成可安装的 AI 技能包，交付给零基础同事使用。", en: "A tech / data-platform role. Wire up platform APIs, build the data foundation, run the servers, ship AI requests — turning repeated work (ad review, asset production, dashboards, OA approvals) into installable AI skill packs that non-technical colleagues can use." },
    "job4.d1": { zh: "API 打通：京东 / 天猫 / 抖音 / 拼多多 + Amazon / Shopify / Temu / 阿里国际站，建自动拉取与鉴权维护", en: "API integration: JD / Tmall / Douyin / PDD + Amazon / Shopify / Temu / Alibaba.com, with automated pulls and credential rotation" },
    "job4.d2": { zh: "数据底座：聚水潭 / 领星 / 钉钉多维表等异构数据归一化，统一指标口径与质量校验", en: "Data foundation: normalise Jushuitan / Lingxing / DingTalk tables, unify metric definitions and data quality checks" },
    "job4.d3": { zh: "AI 需求迭代：技能包开发（SKILL.md + run.py）、安全审计与 SHA 校验、语义化版本发布与回滚", en: "AI delivery: build skill packs (SKILL.md + run.py), security audit with SHA checks, semantic versioning and rollback" },
    "job4.d4": { zh: "服务器部署：云主机 / 容器环境搭建、应用发布与反向代理、公网暴露", en: "Deployment: cloud host / container setup, app release and reverse proxy, public exposure" },
    "job4.d5": { zh: "日常运维：监控告警、定期备份与恢复演练、日志巡检、安全加固", en: "Ops: monitoring and alerting, scheduled backup and restore drills, log patrol, security hardening" },
    "job4.r1": { zh: "大专及以上，统计 / 计算机 / 电商数据相关优先", en: "College degree or above; statistics / CS / e-commerce data background preferred" },
    "job4.r2": { zh: "2 年以上电商数据分析、投流或自动化工程经验", en: "2+ years in e-commerce data analysis, ad operations or automation engineering" },
    "job4.r3": { zh: "熟悉电商指标体、投放逻辑与 SQL / 表处理，能用 Python 或 Node 写脚本", en: "Fluent in e-commerce metrics, ad logic and SQL / spreadsheets; can script in Python or Node" },
    "job4.r4": { zh: "做过看板类应用（如 Flask API + ECharts + SQLite）或同等项目", en: "Has shipped dashboard-grade apps (e.g. Flask API + ECharts + SQLite) or equivalent" },
    "job4.r5": { zh: "逻辑清晰、有工作流洁癖，能把模糊需求拆成可交付的小步", en: "Clear logic and a workflow perfectionist — breaks vague requests into shippable steps" },
    "job4.k1": { zh: "各平台 API 打通", en: "Platform API integration" },
    "job4.k2": { zh: "AI 需求升级迭代", en: "AI delivery iteration" },
    "job4.k3": { zh: "数据底座维护", en: "Data foundation upkeep" },
    "job4.k4": { zh: "服务器部署能力", en: "Server deployment" },
    "job4.k5": { zh: "服务器日常维护", en: "Server maintenance" },
    "job4.sys.val": { zh: "ai-cockpit 看板、生意参谋、京东商智、蝉妈妈、各平台投流后台、billiards-trend-intel", en: "ai-cockpit dashboard, SYCM, JD Shangzhi, Chanmama, platform ad consoles, billiards-trend-intel" },
    "job4.plus": { zh: "加分项：有已发布的可安装技能包作品、熟悉钉钉 / DWS / Aitable 开放平台、做过 OCR 或图像链路。", en: "Bonus: published installable skill packs, familiar with DingTalk / DWS / Aitable open platforms, OCR or imaging pipelines." },
    "job4.red.val": { zh: "泄露经营数据 / 私自操作生产后台 / 敷衍错录造成资损 / 交付未过审的技能包", en: "Leaking business data, unauthorised production access, careless entry causing loss, shipping unaudited skill packs" },
