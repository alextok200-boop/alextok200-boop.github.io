...
(function () {
  var DICT = {
    ...
    "journey.tl3.desc": { zh: "主导 3C 数码配件品牌引进、罗技天猫旗舰店、SanDisk 京东自营等项目的运营落地，从单店到多店铺矩阵。", en: "Led 3C accessory brand introductions, the Logitech Tmall flagship and SanDisk JD store — scaled from single stores to a multi-store matrix." },
    ...
    "resume.j3.p2": { zh: "主导 3C 数码配件品牌引进、罗技天猫旗舰店、SanDisk 京东自营、存储类目天猫专营店等项目落地", en: "Led 3C accessory brand introductions, the Logitech Tmall flagship, SanDisk JD self-operated store and a storage-category Tmall specialty store." },
