...
(function () {
  var DICT = {
    ...
    "journey.tl1.desc": { zh: "负责多品牌电商业务，主打品牌进入亚马逊 5 站类目榜；搭建 15 人 6 岗团队与 49 店铺矩阵，国内海外业务向 50/50 调整。", en: "Leading multi-brand e-commerce: flagship brands ranked on Amazon category lists across 5 marketplaces; built a 15-person 6-role team and a 49-store matrix, rebalancing domestic/overseas toward 50/50." },
    ...
    "resume.j2.p1": { zh: "为领星跨境 ERP 提供财务与合规服务，管理 5 人团队，2018.10 - 2025.10 共 7 年", en: "Finance & compliance services for LingXing cross-border ERP; led a 5-person team; 2018.10 - 2025.10 (7 years)." },
    "resume.j2.p2": { zh: "推动 FBA 库存与跨境财务标准化、月度复盘、KPI 同步、AI Skill 早期开发", en: "Drove FBA inventory & cross-border finance standardisation, monthly reviews, KPI sync, early AI skill development." },
    ...
    "resume.edu.2.school": { zh: "华南理工大学（继教学院）", en: "South China University of Technology (Continuing Education)" },
