...
MAIL_JOB3 = "mailto:alextok200@gmail.com?subject=%E7%AE%80%E5%8E%86%E6%8A%95%E9%80%92-%E8%B7%A8%E5%A2%83%E7%94%B5%E5%95%86%E8%BF%90%E8%90%A5"
MAIL_JOB4 = "mailto:alextok200@gmail.com?subject=%E7%AE%80%E5%8E%86%E6%8A%95%E9%80%92-%E8%BF%90%E8%90%A5%E8%87%AA%E5%8A%A8%E5%8C%96"
...
JOBS_HTML = """        <article class="card feature-card job-card">
        ...
        <article class="card feature-card job-card job-dim">
          <div class="job-head">
            <h3 data-i18n="job3.title">跨境电商运营（Amazon / Temu）</h3>
            <span class="job-tag" data-i18n="job.status.pool">储备</span>
          </div>
          <div class="job-meta">
            <span data-i18n="job3.loc">南通（跨境主阵地）· 南京</span>
            <span data-i18n="job3.type">全职</span>
            <span data-i18n="job3.dept">跨境电商</span>
          </div>
          <p class="job-report">
            <span data-i18n="job.report">汇报对象</span>：<b data-i18n="job3.report.val">跨境负责人 / 平台负责人</b><span class="job-sep">·</span><span data-i18n="job.code">岗位编码</span>：HR-JD-AMZ01 / HR-JD-TEMU02
          </p>
          <p class="job-desc" data-i18n="job3.desc">负责 Amazon 多站点与 Temu 半 / 全托管运营：以 Listing + 广告 + FBA 驱动 GMV 与排名，以备货履约与核价驱动走量与毛利。该岗位为储备状态，业务放量时开放，可先投简历进入人才池。</p>
          <h4 data-i18n="job.duty">岗位职责</h4>
          <ul class="job-list">
            <li data-i18n="job3.d1">Listing：标题 / 图文 / A+ 优化与关键词，维护 Listing 表</li>
            <li data-i18n="job3.d2">广告：SP / SB / SD 结构与 ACOS 优化，做否定词与预算再分配</li>
            <li data-i18n="job3.d3">FBA 库存：补货计划与库存周转，控 IPI，不断货不积压</li>
            <li data-i18n="job3.d4">合规与评分：合规索评、类目审核与账户健康维护</li>
            <li data-i18n="job3.d5">Temu 履约：国内仓备货、核价跟进与爆款选品，控退货率</li>
            <li data-i18n="job3.d6">数据复盘：销量与毛利复盘，输出周报与迭代动作</li>
          </ul>
          <h4 data-i18n="job.req">任职要求</h4>
          <ul class="job-list">
            <li data-i18n="job3.r1">大专及以上，电子商务 / 市场营销优先</li>
            <li data-i18n="job3.r2">2 年以上 Amazon 或 Temu 运营经验，有台球 / 运动器材类目优先</li>
            <li data-i18n="job3.r3">Amazon：懂 A9 算法、关键词与转化逻辑、FBA 与自发货差异、Coupon / BD / LD 节奏</li>
            <li data-i18n="job3.r4">Temu：懂核价逻辑与毛利空间，能推动备货节奏避免断货 / 积压</li>
            <li data-i18n="job3.r5">数据敏感、执行强、抗压，能用数据定位断点并迭代</li>
          </ul>
          <h4 data-i18n="job.kpi">考核口径（KPI · 双线）</h4>
          <ul class="job-kpi">
            <li><span data-i18n="job3.k1">GMV 达成率</span><span class="kpi-w">35%</span></li>
            <li><span data-i18n="job3.k2">ACOS ≤ 红线（Amazon）/ 履约时效 ≤ SLA（Temu）</span><span class="kpi-w">20%</span></li>
            <li><span data-i18n="job3.k3">BSR 排名（Amazon）/ 毛利率 ≥ 红线（Temu）</span><span class="kpi-w">20%</span></li>
            <li><span data-i18n="job3.k4">库存周转（Amazon）/ 缺货率 ≤ 红线（Temu）</span><span class="kpi-w">15%</span></li>
            <li><span data-i18n="job3.k5">评分 ≥ 红线（Amazon）/ 退货率 ≤ 红线（Temu）</span><span class="kpi-w">10%</span></li>
          </ul>
          <p class="job-sys">
            <span data-i18n="job.sys">常用系统</span>：<b data-i18n="job3.sys.val">Amazon Seller Central（美 / 加 / 英 / 德 / 日 5 站）、广告与品牌分析、Temu 半托管·全托管后台</b>
          </p>
          <p class="job-plus" data-i18n="job3.plus">加分项：Amazon 多站点（美 / 加 / 英 / 德 / 日）实操、海外仓资源、小语种。</p>
          <p class="job-redline">
            <b data-i18n="job.red">红线（一票否决）</b>：<span data-i18n="job3.red.val">刷评 / 刷单 / 跟卖侵权 / 规避二审 / 虚假发货 / 货不对板 / 恶意低价扰乱</span>
          </p>
        ...
        <article class="card feature-card job-card job-dim">
          <div class="job-head">
            <h3 data-i18n="job4.title">运营自动化 / AI 技能包工程</h3>
            <span class="job-tag" data-i18n="job.status.pool">储备</span>
          </div>
          <div class="job-meta">
            <span data-i18n="job4.loc">远程协作 · 南京</span>
            <span data-i18n="job4.type">全职 / 兼职</span>
            <span data-i18n="job4.dept">数据与增长（技术中台）</span>
          </div>
          <p class="job-report">
            <span data-i18n="job.report">汇报对象</span>：<b data-i18n="job4.report.val">技术负责人 / 副总</b><span class="job-sep">·</span><span data-i18n="job.code">岗位编码</span>：HR-JD-DA06 / AI 技术人员 v1.0.0
          </p>
          <p class="job-desc" data-i18n="job4.desc">技术 / 数据中台支撑岗。打通各平台 API → 沉淀数据底座 → 运维服务器 → 迭代 AI 需求，把投流审核、视觉生产、数据看板、OA 审批这类重复工作封装成可安装的 AI 技能包，交付给零基础同事使用。</p>
          <h4 data-i18n="job.duty">岗位职责</h4>
          <ul class="job-list">
            <li data-i18n="job4.d1">API 打通：京东 / 天猫 / 抖音 / 拼多多 + Amazon / Shopify / Temu / 阿里国际站，建自动拉取与鉴权维护</li>
            <li data-i18n="job4.d2">数据底座：聚水潭 / 领星 / 钉钉多维表等异构数据归一化，统一指标口径与质量校验</li>
            <li data-i18n="job4.d3">AI 需求迭代：技能包开发（SKILL.md + run.py）、安全审计与 SHA 校验、语义化版本发布与回滚</li>
            <li data-i18n="job4.d4">服务器部署：云主机 / 容器环境搭建、应用发布与反向代理、公网暴露</li>
            <li data-i18n="job4.d5">日常运维：监控告警、定期备份与恢复演练、日志巡检、安全加固</li>
          </ul>
          <h4 data-i18n="job.req">任职要求</h4>
          <ul class="job-list">
            <li data-i18n="job4.r1">大专及以上，统计 / 计算机 / 电商数据相关优先</li>
            <li data-i18n="job4.r2">2 年以上电商数据分析、投流或自动化工程经验</li>
            <li data-i18n="job4.r3">熟悉电商指标体、投放逻辑与 SQL / 表处理，能用 Python 或 Node 写脚本</li>
            <li data-i18n="job4.r4">做过看板类应用（如 Flask API + ECharts + SQLite）或同等项目</li>
            <li data-i18n="job4.r5">逻辑清晰、有工作流洁癖，能把模糊需求拆成可交付的小步</li>
          </ul>
          <h4 data-i18n="job.kpi">考核口径（KPI）</h4>
          <ul class="job-kpi">
            <li><span data-i18n="job4.k1">各平台 API 打通</span><span class="kpi-w">25%</span></li>
            <li><span data-i18n="job4.k2">AI 需求升级迭代</span><span class="kpi-w">25%</span></li>
            <li><span data-i18n="job4.k3">数据底座维护</span><span class="kpi-w">22%</span></li>
            <li><span data-i18n="job4.k4">服务器部署能力</span><span class="kpi-w">15%</span></li>
            <li><span data-i18n="job4.k5">服务器日常维护</span><span class="kpi-w">13%</span></li>
          </ul>
          <p class="job-sys">
            <span data-i18n="job.sys">常用系统</span>：<b data-i18n="job4.sys.val">ai-cockpit 看板、生意参谋、京东商智、蝉妈妈、各平台投流后台、billiards-trend-intel</b>
          </p>
          <p class="job-plus" data-i18n="job4.plus">加分项：有已发布的可安装技能包作品、熟悉钉钉 / DWS / Aitable 开放平台、做过 OCR 或图像链路。</p>
          <p class="job-redline">
            <b data-i18n="job.red">红线（一票否决）</b>：<span data-i18n="job4.red.val">泄露经营数据 / 私自操作生产后台 / 敷衍错录造成资损 / 交付未过审的技能包</span>
          </p>
...
ENTRIES = [
    ...
    ("job3.title", "跨境电商运营（Amazon / Temu）", "Cross-border E-commerce Operator (Amazon / Temu)"),
    ("job3.loc", "南通（跨境主阵地）· 南京", "Nantong (cross-border hub) · Nanjing"),
    ("job3.type", "全职", "Full-time"),
    ("job3.dept", "跨境电商", "Cross-border E-commerce"),
    ("job3.report.val", "跨境负责人 / 平台负责人", "Cross-border Lead / Platform Lead"),
    ("job3.desc", "负责 Amazon 多站点与 Temu 半 / 全托管运营：以 Listing + 广告 + FBA 驱动 GMV 与排名，以备货履约与核价驱动走量与毛利。该岗位为储备状态，业务放量时开放，可先投简历进入人才池。",
    ...
    # ---- 岗位四：运营自动化 / AI 技能包工程 ----
    ("job4.title", "运营自动化 / AI 技能包工程", "Ops Automation / AI Skill Pack Engineering"),
    ("job4.loc", "远程协作 · 南京", "Remote · Nanjing"),
    ("job4.type", "全职 / 兼职", "Full-time / Part-time"),
    ("job4.dept", "数据与增长（技术中台）", "Data & Growth (Tech Platform)"),
    ("job4.report.val", "技术负责人 / 副总", "Tech Lead / VP"),
    ("job4.desc", "技术 / 数据中台支撑岗。打通各平台 API → 沉淀数据底座 → 运维服务器 → 迭代 AI 需求，把投流审核、视觉生产、数据看板、OA 审批这类重复工作封装成可安装的 AI 技能包，交付给零基础同事使用。",
