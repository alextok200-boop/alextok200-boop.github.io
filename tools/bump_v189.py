#!/usr/bin/env python3
"""批量 bump 全站缓存击穿号：v1.8.8 → v1.8.9（HTML ?v= + sw.js CACHE 名）"""
import os

SITE_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
PAIRS = [("?v=1.8.8", "?v=1.8.9"), ("konllen-site-v1.8.8", "konllen-site-v1.8.9")]
...
print(f"完成：{touched} 个文件、{total} 处替换 → v1.8.9")
